...
window.require.register("controllers/header", function(exports, require, module) {
...
window.require.register("controllers/main", function(exports, require, module) {
  ...
  module.exports = MainController = (function(_super) {
...
window.require.register("lib/canopy/d3/circlepack", function(exports, require, module) {
  'use strict';
  var CirclePack;
...
window.require.register("lib/canopy/d3/radialtree", function(exports, require, module) {
  'use strict';
  var RadialTree;
...
window.require.register("lib/canopy/github", function(exports, require, module) {
  'use strict';
  module.exports = {
...
window.require.register("lib/canopy/tree", function(exports, require, module) {
  'use strict';
  module.exports = {
...
window.require.register("views/main", function(exports, require, module) {
  ...
  module.exports = MainView = (function(_super) {
    ...
    function MainView() {
      var _this = this;
      this.zoom = function(node) {
        return MainView.prototype.zoom.apply(_this, arguments);
      };
      this.loadGitRepo = function() {
        return MainView.prototype.loadGitRepo.apply(_this, arguments);
      };
    ...
    MainView.prototype.renderList = function(data) {
      ...
      items = (function() {
        ...
        for (_i = 0, _len = data.length; _i < _len; _i++) {
          node = data[_i];
          _results.push("<div>" + node.path + "</div>");
        }
        return _results;
      })();
...
window.require.register("views/templates/main", function(exports, require, module) {
  module.exports = Handlebars.template(function (Handlebars,depth0,helpers,partials,data) {
    this.compilerInfo = [2,'>= 1.0.0-rc.3'];
  helpers = helpers || Handlebars.helpers; data = data || {};
