...
window.require.register("test/views/header-test", function(exports, require, module) {
...
window.require.register("test/views/main-test", function(exports, require, module) {
  var MainView;
...
window.require('test/views/header-test');
window.require('test/views/main-test');
